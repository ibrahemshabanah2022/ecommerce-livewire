<div>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme ">
        ...
        <ul class="menu-inner py-1">
            ...
            {{-- <a :href="route('add-category')" wire:navigate>Add Category</a> --}}

            <li class="menu-header small text-uppercase">
                <span class="menu-header-text"><a href="{{ route('add-category') }}" class="menu-link" wire:navigate>
            ...
            <li class="menu-header small text-uppercase">
                <span class="menu-header-text"><a href="{{ route('display-users') }}" class="menu-link" wire:navigate>
